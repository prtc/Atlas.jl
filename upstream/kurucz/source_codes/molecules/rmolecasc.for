      PROGRAM RMOLECASC
c     revised 16jul18   AlH, ScH, TiH, VH added (lines only for TiH)
...
c      PRINT 3,ILINE,WL,GFLOG,XJ,E,XJP,EP,CODE,LABEL(1),LABELP(1),ISO
     ...
     1 180,99,99,99,99,230,240,250,260,270,280,290,300,99,99,330,
     2 99,99,99,99,99,390,400,410,420,430,440,450,460,470,480,490,500,
...
C     TiH
 4900 NELION=366
      ...
      X2=-1.259
      GO TO 5000
  500 IF(CODE.EQ.124.)GO TO 5020
      IF(CODE.EQ.122.)GO TO 5010
C     TiO
      NELION=366
      FUDGE=0.00
      ISO1=16

...
C     IF IT IS OPTIMIZED FOR EACH FILE IT CAN BE MADE TO RUN MUCH FASTER
     ...
     3            2H31,2H32,2H33/
      OPEN(UNIT=11,STATUS='OLD',FORM='UNFORMATTED',READONLY,SHARED,
     ...
     1WLBEG,WLEND,RESOLU,RATIO,RATIOLG,CUTOFF,LINOUT                            
      ...
      STOP1=STOP+1.
      N=0                                                                   
      DO 20 ILINE=1,9999999
      READ(11,END=21)WL,E,EP,LABEL(1),LABELP(1),GFLOG,XJ,XJP,CODE,ISO
...
C     SiO
 ...
 5000 GF=EXP((GFLOG+X1+X2)*2.30258509299405E0)                                          
      ...
      IF(CLABELP(1:1).EQ.'X')GAMMAR=GAMMAR*.001
      GAMRF=GAMMAR/FRQ4PI                                                       
      GAMSF=GAMMAS/FRQ4PI                                                       
      GAMWF=GAMMAW/FRQ4PI                                                       

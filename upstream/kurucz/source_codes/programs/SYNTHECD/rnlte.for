...
C      EFFNSQ=AMIN1(EFFNSQ,100.)
  ...
  144 FORMAT(F11.4,F7.3,F5.1,F12.3,F5.1,F12.3,F9.2,A8,A2,A8,A2,F7.4/
     ...
     2F7.4,F7.3,3F6.2,A20)
      IF(LINOUT.GE.0)WRITE(I13)LINDAT8,LINDAT

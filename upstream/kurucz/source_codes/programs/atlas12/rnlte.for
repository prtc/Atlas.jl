...
C     CALL BEGTIME
  ...
  140 FORMAT(F10.4,F7.3,F5.1,F12.3,F5.1,F12.3,F9.2,A8,A2,A8,A2,F7.4/
     ...
     2F7.4,F7.3,3F6.2,A20)
      ...
      IF(IFVAC.EQ.1.OR.LABELP(1).EQ.8HCONT    )WLVAC=
     1 1.D7/DABS(DABS(EP)-DABS(E))+DWL+DWLISO
      IF(LABELP(1).EQ.(8HCONT      ).AND.WLVAC.GT.WLEND)GO TO 900

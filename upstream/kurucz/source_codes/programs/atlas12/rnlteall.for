...
C     IXFIXFP IS HYPERFINE NOTATION
      ...
      WLVAC=1.D7/DABS(DABS(EP)+ESHIFTP-DABS(E)+ESHIFT)+DWLISO
      NBUFF=DLOG(WLVAC)/RATIOLG
C     LIM IS PROBABLY OBSOLETE
C     LIM=MIN(8-LINESIZE,7)
C     IF(CODE.EQ.1.)LIM=1
...
C     GR IS GAUNT FACTOR FOR CORONAL LINES
 ...
 1251 FORMAT(9H BAD CODE,F10.2)
      CALL EXIT
 1252 NELIONX=I
C1253 WRITE(19)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
C    1GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
C     WRITE(2,222)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
C    1GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
C 222 FORMAT(F12.4,F12.3,1PE12.3,6I5,3E12.3,I10,I5)
 1253 WRITE(19)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
     1GAMMAR,GAMMAS,GAMMAW,NBUFF
      WRITE(6,222)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
     1GAMMAR,GAMMAS,GAMMAW,NBUFF
  222 FORMAT(F12.4,F12.3,1PE12.3,6I5,3E12.3,I10)
      N19=N19+1
  900 CONTINUE

...
C
      ...
      OPEN(UNIT=JT5,STATUS='NEW',RECL=160,CARRIAGECONTROL='LIST')
...
C     PRINT 5,WL,GFLOG,K,KP,IFPRED
    5 FORMAT(F18.8,F7.3,I5,I5,I1,I4)
      ...
      REF='K09'//EMQ
      REF='K10'//EMQ
      ASUMASUMP=ASUM+ASUMP
      IF(ASUMASUMP.EQ.0.D0)ASUMASUMP=1.03D-10
      GAMMAR=LOG10(ASUMASUMP)
...
C
      ...
      IF(WAVENO.EQ.0.D0)WAVENO=0.001D0
      WLVAC=1.D7/WAVENO
      WL=MIN(WL,999999.9999D0)
      WLVAC=MIN(WLVAC,999999.9999D0)
      WAVENO=MIN(WAVENO,9999999.9999D0)
      GFLOG=GALOG-LOG10(66702.D9/WLVAC**2)
C     .LINES
...
C     GA*.POS
     ...
     1 NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,LANDE,LANDEP,ISOSHIFT
C     GF*.POS
      WRITE(JT5,140)WL,GFLOG,CODE,ELAB,ELABP,GAMMAR,GAMMAS,GAMMAW,REF,
     1 NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,LANDE,LANDEP,ISOSHIFT
C     GF*.METAPOS
